...
sEmptyTable:"No data available in table",sInfo:"نمایش _START_ تا _END_ از _TOTAL_ نتایج",sInfoEmpty:"نمایش 0 تا 0 از 0 نتایج",sInfoFiltered:"(فیلتر شده از _MAX_ نتیجه)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"نمایش _MENU_ نتایج",sLoadingRecords:"در حال بارگذاری...",sProcessing:"Processing...",sSearch:"جست و جو : ",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"نتیجه ای یافت نشد."},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
